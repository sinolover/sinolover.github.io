...
看下类图  
![在这里插入图片描述](vx_images/506791418254923.png)  
**工厂方法模式**
...
看下类图  
![在这里插入图片描述](vx_images/503711418261631.png)  
![在这里插入图片描述](vx_images/501631418245536.png)  
工厂方法适用于以下场景：  
1、创建对象需要大量重复的代码。  
...
最后看下抽象工厂模式的类图：  
![在这里插入图片描述](vx_images/499531418245880.png)